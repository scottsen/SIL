...
**Status:** ✅ Production v0.13.1 | [PyPI](https://pypi.org/project/reveal-cli/) | [GitHub](https://github.com/semantic-infrastructure-lab/reveal)
...
We've **implemented and validated** `--agent-help` in Reveal v0.13.0+ - proving the standard works at production scale.
